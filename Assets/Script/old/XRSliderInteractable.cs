...
namespace UnityEngine.XR.Content.Interaction
{
    ...
    /// </summary>
    public class XRSliderInteractable : XRBaseInteractable
    {
        [Serializable]
        ...
        XRGrabInteractable m_Handle = null;
        ...
        void SetSliderPosition(float value)
        {
            ...
            var handlePos = m_Handle.attachTransform.localPosition;
            handlePos.z = Mathf.Lerp(m_MinPosition, m_MaxPosition, value);
            m_Handle.attachTransform.localPosition = handlePos;
        }
